...
namespace Company.MyProj.Web.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Login,Nome,Status")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Login,Nome,Status")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
